...
public class KalendarActivity extends AppCompatActivity {
    ...
    private void mjesecOdabran(int mjesecId) {
        ...
        gridSijeSe.setAdapter((ListAdapter) new Biljka_Adapter(this,0,biljkeKojeSeSiju));
        gridBereSe.setAdapter((ListAdapter) new Biljka_Adapter(this,0,biljkeKojeSeBeru));
    }
}
